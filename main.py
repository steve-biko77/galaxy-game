...
class MainWidget(RelativeLayout):
    ...
    menu_button_title=StringProperty("PLAY")
    ...
    def update(self, dt):
        # print("dt : " + str(dt*60))
        time_factor = dt*60
        # Dans update(), avant de dessiner les lignes/tiles
        hue = (self.current_y_loop * 2) % 360
        Color(*colorsys.hsv_to_rgb(hue/360, 0.8, 1), mode='hsv')
        ...
        if not self.check_ship_collisions() and not self.state_game_over:
            ...
            Clock.schedule_once(self.play_voice_game_over, 2.5)
